...
export type StackParamList = {
  ...
  ShowProgress: OnbaordingRouteParams;
  EnterName: OnbaordingRouteParams & IEnterNameProps;
  EnterEmailAddress: OnbaordingRouteParams;
  EnterCountry: OnbaordingRouteParams;
  EnterPinCode: OnbaordingRouteParams;
  VerifyPinCode: OnbaordingRouteParams;
  EnableBiometrics: OnbaordingRouteParams;
  AcceptTerms: OnbaordingRouteParams;
  ReadTerms: OnbaordingRouteParams;
  //
...
export type OnbaordingRouteParams = IHasOnboardingContext & {
  step: number;
};
